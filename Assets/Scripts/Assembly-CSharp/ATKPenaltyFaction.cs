...
public class ATKPenaltyFaction : CreatureScript
{
	...
	public override void PopulateLaneMods()
	{
		...
		foreach (Lane item in lanes)
		{
			if (item.HasCreature())
			{
				...
				{
					CardScript.LaneMods[(int)(!base.Owner), creature.CurrentLane.Index].ATK = -Math.Min(creature.ATK, base.Data.Val2);
				}
			}
		}
	}
	...
	{
		(target as CreatureScript).ATKMod -= base.Data.Val2;
		return true;
	}
}
