...
public class SwapATKDEFSelf : SpellScript
{
	...
	public override bool DoResult(CardScript target)
	{
		...
		int baseATK = target.Data.Form.BaseATK;
		int baseDEF = target.Data.Form.BaseDEF;
		int aTK = creatureScript.ATK;
		int aTKMod = creatureScript.DEF - baseATK;
