...
public class HealTarget : CreatureScript
{
	...
	public override void PopulateLaneMods()
	{
		...
		CreatureScript creatureScript = CardScript.BestCandidateForHealing(candidates, base.Data.Val1, true);
		CardScript.LaneMods[(int)base.Owner, creatureScript.CurrentLane.Index].DEF = Math.Min(base.Data.Val1, creatureScript.Damage);
	}
