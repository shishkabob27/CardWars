...
public class DamageTargetFaction : CreatureScript
{
	public override bool CanFloop()
	{
		...
		{
			if (item.HasCreature() && item.GetCreature().Data.Form.Faction == (Faction)base.Data.Form.BaseVal2)
			{
				return true;
			}
		}
	...
	{
		if (candidate.HasCreature() && candidate.GetCreature().Data.Form.Faction == (Faction)base.Data.Form.BaseVal2)
		{
			return true;
		}
		return false;
