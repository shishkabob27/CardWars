...
public class ATKDEFBonusFactionCreaturesLeader : LeaderScript
{
	...
	public override bool DoResult(CardScript target)
	{
		...
		creatureScript.ATKMod += base.Leader.Form.BaseVal1;
		creatureScript.DEFMod += base.Leader.Form.BaseVal2;
		return true;
	}
}
