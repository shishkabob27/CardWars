...
public class DEFBonusAllCreaturesLeader : LeaderScript
{
	...
	public new static int EvaluateLanePlacement(PlayerType player, Lane lane, CardItem item)
	{
		...
		foreach (Lane item2 in lanes)
		{
			if (item2.HasCreature())
			{
				...
				CardScript.LaneMods[(int)player, creature.CurrentLane.Index].DEF = leader.Form.BaseVal1;
			}
		}
	...
	{
		(target as CreatureScript).DEFMod += base.Leader.Form.BaseVal1;
		return true;
	}
}
